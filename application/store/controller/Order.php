...
//            $arr = $model->where('id','=',715)->find()->toArray();
//            dump(serialize($arr));die;
//        }
        //获取退款商品信息
...
//            dump($coupon);die;
     ...
     *
     */
    public function comfirm($post_sendout='',$cart_ids='',$seller_msg='',$addressId=0,$fxPhone='',$storeid='',$discount_rate='',$sendout=1,$shippingfee=0,$couponId=0,$userCouponId=0,$discount_price=0,$fx_user_id='',$daifu=''){
        echo $cart_ids;
        echo $seller_msg;
        echo $addressId;
        echo $fxPhone;
