        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    <!-- 工具栏 -->
                    <?php if(session('yoshop_store.is_admin')){?>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <a href="<?= $item['logo'] ?>" title="点击查看大图" target="_blank">
                                            <img src="<?= $item['logo'] ?>" width="72" height="72" alt="">
                                        </a>
                                    </td>
                                    <td class="am-text-middle"><?= $item['store_start_time'] ?></td>
                                    <td class="am-text-middle"><?= $item['store_username'] ?></td>
                                    <td class="am-text-middle"><?= $item['store_mobile'] ?></td>


                                    <td class="am-text-middle">
                                            <span class="am-badge am-badge-<?= $item['is_open'] ? 'success' : 'warning' ?>">
                                               <?= $item['is_open'] ? '启用' : '禁用' ?>
                                           </span>
                                    </td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('shop/edit')): ?>
                                                <a href="<?= url('shop/edit', ['id' => $item['id']]) ?>">
