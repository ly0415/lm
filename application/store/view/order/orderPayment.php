                                    ...
                                    <div class="contentBox" >
                                        ...
                                        <div class="orderSuccess">
                                            ...
                                            <div class="customerTime">
                                                ...
                                                <div class="lines am-padding-top">
                                                    <span>选择用户：</span>
                                                    <div class="am-u-sm-10 am-fl" style="padding-left:0;">
                                                        <div class="am-u-sm-12 am-u-end" style="padding:0;display:flex;">
                                                            <div class="select-content am-form-group" style="margin-bottom:0;">
                                                                <input  type="text" id="select_input" class="select-input" value="" autocomplete="off" placeholder="请输入手机号" />
                                                            ...
                                                            <small class="am-margin-left-xs">
                                                                ...
                                                                <span style="margin:8px 0 0 10px;">已选择：<span style="margin:8px 0 0 10px;" id="j-select-phone">无</span></span>
                                                                <input type="hidden"  name="order[phone]" id="j-hidden-phone" value="">
                                                            </small>
                                                        </div>
...
<script>
    ...
       }
        ...
        $('.j-selectUser').click(function () {
            ...
            var $_selectPhone   = $('#j-select-phone');
            var $_hiddenPhone   = $('#j-hidden-phone');
            $.selectData({
                title: '选择用户',
                ...
                dataIndex: 'id',
                    ...
                    $_selectPhone.text(user.phone);
                    $_hiddenPhone.val(user.phone);
                    getCoupon();
                    getFxInfo()
                }
            });
        ...
        $(document).on('click','.select-ul li',function(){
            ...
            $('#j-select-phone').text(txt);
            $('#j-hidden-phone').val(txt);
            $('.select-ul').hide();
            getCoupon();
            getFxInfo();
        })
        ...
        $(document).on('click','.yinlian',function(){
            ...
            var phone = $.trim($('#j-hidden-phone').val());
            if(!phone){
                layer.msg('请填写手机号');
                return false;
            }
