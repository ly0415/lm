                ...
                <div class="widget-body am-fr">
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <form id="form-search" class="toolbar-form" action="">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <?php if (checkPrivilege('store/balance.balance_coupon/export')): ?>
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
<!--                                    --><?php //if (checkPrivilege('balance.balance_coupon/add')): ?>
<!--                                        <div class="am-btn-group am-btn-group-xs">-->
<!--                                            <a class="am-btn am-btn-secondary am-btn-xs" type="type" data-am-modal="{target: '#doc-modal-1'}"-->
<!--                                               href="--><?//= url('balance.balance_coupon/add') ?><!--">-->
                                    ...
                                    <div class="am fr">
                                        <div class="am-form-group am-fl">
                                            <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                                <input type="text" class="am-form-field" name="sn" placeholder="请输入券码" value="<?= $request->get('sn') ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
