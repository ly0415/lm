                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="goods_category[parent_id]"
                                        ...
                                        <?php if (isset($list)): foreach ($list as $first): ?>
                                            <option value="<?= $first['id'] ?>"  <?php if($model['parent_id'] == $first['id'])echo 'selected';?> <?php if($model['id'] == $first['id'])echo 'disabled';?>>
                                                <?= $first['name'] ?></option>
                                            <?php if (isset($first['child'])): foreach ($first['child'] as $first1): ?>
                                                <option value="<?= $first1['id'] ?>" <?php if($model['parent_id'] == $first1['id'])echo 'selected';?> <?php if($model['id'] == $first1['id'])echo 'disabled';?>>
