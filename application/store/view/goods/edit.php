                        ...
                        <div class="am-tab-panel am-active am-in">
                            <div class="widget am-cf">
                                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                                    ...
                                    <div class="am-form-group">
                                        <label for="originalStock" class="am-u-sm-2 am-form-label"> 商品编号：</label>
                                        <div class="am-u-sm-8 am-u-end">
                                            <input id="originalStock" autocomplete="off" type="text" class="tpl-form-input" value="<?= $details['goods_sn'] ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                        ...
                        <div class="am-tab-panel">
                            <div class="widget am-cf">
                                <div class="am-form-group am-fr">
                                    <?php if(checkPrivilege('goods/batch') && STORE_ID == 98 && $details['isExistSpec']):?>
