                        ...
                        <form class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    ...
                                    <?php endif; ?>
                                    <?php if (checkPrivilege('goods/cafe')): ?>
                                        <div class="am-btn-group am-btn-group-xs">

                                            <?php if(IS_ADMIN):?>
                                                <a class=" am-btn am-btn-default am-btn-success"
                                                   href="<?=url('goods/cafe')?>">
                                                    <span class="am-icon-plus"></span> 咖啡机商品
                                                </a>
                                            <?php endif;?>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php if (checkPrivilege('goods/set_model')): ?>
                                                <a href="<?= url('goods/set_model', ['id' => $item['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 设置模型
                                                </a>
                                            <?php endif; ?>
