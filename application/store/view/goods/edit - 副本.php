                            ...
                            <div class="widget am-cf">
                                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                                    ...
                                    <div class="am-form-group am-padding-top">
                                        <label class="am-u-sm-2 am-u-lg-2 am-form-label form-">辅助业务分类：</label>
                                    ...
                                    <div class="am-form-group yewu_kinds" style="display:none">
                                        <label class="am-u-sm-2 am-u-lg-2 am-form-label "></label>
                                        <div class="am-u-sm-10 am-u-end">
                                            <select name="catetype[cate_type]" data-am-selected="{btnSize: 'sm'}"  >
...
<script>
    ...
    $(function () {
        ...
        $('select[name="goods[cat_id]"]').on('change',function () {
            ...
            var cat_id = $(this).val();
            var goods_type = $('select[name="catetype[cate_type]"]');
            var _html = "<option value='0'>请选择业务类型</option>";
            if(cat_id > 0){
                $.post("<?=url('store.business/getCategoryId')?>",{category_id:cat_id},function (res) {
                    $.each(res.data, function (i, e) {
                        _html += '<option value="' + e.id + '">' + e.room_name + '</option>';
                    });
