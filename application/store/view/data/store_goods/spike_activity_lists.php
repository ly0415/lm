        ...
        <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
            <tr>
                <td class="am-text-middle">
                    <label class="am-checkbox">
                        <input <?php if(in_array($item['id'],$goods_ids)){echo 'checked';}?> data-am-ucheck data-check="item" data-params='<?= json_encode([
                                'id'=>$item['id'],
                            'goods_id' => (string)$item['goods_id'],
                            'goods_img' => $item['original_img'],
