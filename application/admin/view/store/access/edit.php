                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">是否总站权限 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="access[is_site]" value="0" <?php if($model['is_site'] == 0){echo 'checked';}?>
                                               data-am-ucheck>
                                        否
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="access[is_site]" <?php if($model['is_site'] == 1){echo 'checked';}?> value="1" data-am-ucheck>
                                        是
                                    </label>
                                </div>
                            </div>
