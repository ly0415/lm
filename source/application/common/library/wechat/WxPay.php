...
class WxPay extends WxBase
{
     ...
     * @param $config
     */
    public function __construct($config,$service = false)
    {
        if ($config !== false) {
     ...
     */
    public function unifiedorder($orderSn, $openId,$payPrice,$service = false, $orderType = OrderTypeEnum::MASTER)
    {
        // 当前时间
        $time = time();
        // 生成随机字符串
        $nonceStr = md5($time . $this->createNonceStr());
        //普通商户
        $params = [
            'appid' => $this->appId,
            ...
            'total_fee' => $payPrice * 100, // 价格:单位分
            'trade_type' => 'JSAPI',
        ];
//        dump($params);die;
        // 生成签名
        $params['sign'] = $this->makeSign($params,$service ? $this->service['apikey']:$this->config['apikey']);
        // 请求API
...
//        dump($result);die;
        ...
        // 生成 nonce_str 供前端使用
        $paySign = $this->makePaySign(Config::get('xcx')['app_id'],$params['nonce_str'], $prepay['prepay_id'], $time,$service ? $this->service['apikey']:$this->config['apikey']);
        return [
    ...
    {
//        $xml = <<<EOF
//<xml><appid><![CDATA[wxa07a37aef375add1]]></appid>
//<attach><![CDATA[{"order_type":1}]]></attach>
//<bank_type><![CDATA[CFT]]></bank_type>
//<cash_fee><![CDATA[1]]></cash_fee>
//<fee_type><![CDATA[CNY]]></fee_type>
//<is_subscribe><![CDATA[Y]]></is_subscribe>
//<mch_id><![CDATA[1450526802]]></mch_id>
//<nonce_str><![CDATA[hrv3trz78ufyr7ub4nyxr7wp8x2pliv2]]></nonce_str>
//<openid><![CDATA[o2BYGjzz3r1Odi8bAw37sRxPtxaA]]></openid>
//<out_trade_no><![CDATA[201911040931174066]]></out_trade_no>
//<result_code><![CDATA[SUCCESS]]></result_code>
//<return_code><![CDATA[SUCCESS]]></return_code>
//<sign><![CDATA[B3167D68454CE707683E2B43453EB6D5]]></sign>
//<sub_mch_id><![CDATA[1553824111]]></sub_mch_id>
//<time_end><![CDATA[20191104093413]]></time_end>
//<total_fee>1</total_fee>
//<trade_type><![CDATA[NATIVE]]></trade_type>
//<transaction_id><![CDATA[4200000407201911042028623662]]></transaction_id>
//</xml>
//EOF;
        ...
        file_put_contents(dirname(__FILE__).'/xml/aassss.php',$xml);
        // 将服务器返回的XML数据转化为数组
...
//            dump($data);dump($order);die;
            // 订单支付成功业务处理
            $OrderModel->paySuccess(PayTypeEnum::WECHAT, $data,$order);
            // 返回状态
    ...
    public function queryOrderInfo($order_sn){
        ...
        // 生成签名
        $params['sign'] = $this->makeSign($params,$this->config['apikey']);
        // 请求API
     ...
     * @return string
     */
    private function makePaySign($appId,$nonceStr, $prepay_id, $timeStamp,$apikey)
    {
        $data = [
            'appId' => $appId,
            'nonceStr' => $nonceStr,
