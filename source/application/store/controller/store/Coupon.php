...
use app\store\model\RechargePoint;
...
class Coupon extends Controller
{
    ...
    public function addDeduction()
    {
        if (!$this->request->isAjax()) {
            //充值规则
            $reCoupon = RechargePoint::getListALL();
            return $this->fetch('add',compact('reCoupon'));
        }
        // 新增记录
        if ($this->model->addCoupon($this->postData('coupon'))) {
            return $this->renderSuccess('添加成功', url('store.coupon/index'));
        }
