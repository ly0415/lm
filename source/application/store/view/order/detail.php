...
<!--                                    <td>待开发</td>-->
                    ...
                    <?php if($orderRefundDetail): ?>
                        ...
                        <div class="tips am-margin-bottom-sm am-u-sm-12">
                            <div class="pre">
                                <p>当前买家已付款并申请退款，审核通过：1、余额支付的订单退款金额原路返回，其余方式都需要门店长自己手动处理   2、拒绝退款不产生任何金额变更</p>
                            </div>
                        </div>
                        <div class="am-scrollable-horizontal">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($_data['refund_order'] as $key => $goods): ?>
                                        <tr>
                                            ...
                                            <td>×<?= $goods['goods_num'] ?></td>
                                            <td>￥<?= $goods['goods_price'] ?></td>
                                            <td><?= $orderDetail['payment_type'] == 3 ? '余额':'线下'; ?></td>
                                            <td>￥<?= ($goods['goods_price'] * $goods['goods_num']) ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <tr>
                                        <td colspan="6" class="am-text-right am-cf">
                                            <span class="am-fr">退款总计：￥<?= $orderDetail['goods_amount'] ?></span>
                                        </td>
