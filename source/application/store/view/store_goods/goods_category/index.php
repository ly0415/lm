                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                <?php if (checkPrivilege('store_goods.goods_category/add')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success am-radius"
                                           href="<?= url('store_goods.goods_category/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('store_goods.goods_category/edit')): ?>
                                                <a href="<?= url('store_goods.goods_category/edit',
                                                    ['id' => $first['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('store_goods.goods_category/delete')): ?>
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('store_goods.goods_category/delete') ?>";
