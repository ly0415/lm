<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\role\index.php";i:1571624106;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1571624106;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!empty($list)): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <?php if(T_ADMIN){?>
                                        <td class="am-text-middle"><?= $item['business']['name'] ?></td>
                                    <?php }?>
