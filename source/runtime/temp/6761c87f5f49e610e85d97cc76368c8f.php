                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <?php if (checkPrivilege('shop.user/add')): ?>
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a class="am-btn am-btn-default am-btn-success"
                                                       href="<?= url('shop.user/add') ?>">
                                ...
                                <div class="am fr">
                                    ...
                                    <div class="am-form-group am-fl">
                                        <select name="store_id"
                                            ...
                                            <option value=""></option>
                                            <option value="0"
                                                <?= $store_id === '0' ? 'selected' : '' ?>>全部
                                            </option>
                                            <?php foreach ($shopList as $shop){?>
                                                <option  <?php if(isset($where['store_id'])&&$where['store_id']== $shop['id']){echo 'selected';} ?> value="<?=$shop['id']?>"><?=$shop['store_name']?></option>
                                            <?php }?>
                                    ...
                                    <div class="am-form-group am-fl">
                                        <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                            <input type="text" class="am-form-field" name="username"
                                                   placeholder="请输入用户名" value="<?= $request->get('username') ?>">
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <?php if(IS_ADMIN){?>
                                    <td class="am-text-middle"><?= $item['store']['store_name'] ?></td>
                                    <?php }?>
                                    <td class="am-text-middle">
                                        <?php if($item['role']){
                                            foreach ($item['role'] as $k => $role){

                                                echo $role['role_name'];
                                                if($k != count($item['role']) - 1){
                                                    echo '，';
                                                }
                                            }
                                        }
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php if (($store['user']['store_user_id'] != $item['id'])
                                                && !$item['is_super']):if (checkPrivilege('shop.user/edit')): ?>
                                                    <a href="<?= url('shop.user/edit', ['user_id' => $item['id']]) ?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                <?php endif; if (checkPrivilege('shop.user/delete')): ?>
                                                    <a href="javascript:void(0);"
