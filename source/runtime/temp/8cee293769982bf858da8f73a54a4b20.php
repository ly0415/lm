                    ...
                    <div class="widget-body">
                        <fieldset>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="goods_category[parent_id]"
                                        ...
                                        <?php if (isset($list)): foreach ($list as $first): ?>
                                            <option value="<?= $first['id'] ?>"  <?php if($model['parent_id'] == $first['id'])echo 'selected';if($model['id'] == $first['id'])echo 'disabled';?>>
                                                <?= $first['name'] ?></option>
                                            <?php if (isset($first['child'])): foreach ($first['child'] as $first1): ?>
                                                <option value="<?= $first1['id'] ?>" <?php if($model['parent_id'] == $first1['id'])echo 'selected';if($model['id'] == $first1['id'])echo 'disabled';?>>
                                    ...
                                    <div class="am-form-file">
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php if ($model['image']): ?>
                                                ...
                                                <div class="file-item">
                                                    <a href="<?=$model['image']['big_file_path']?>" title="点击查看大图" target="_blank">
                                                        <img src="<?=$model['image']['small_file_path']?>">
                                                    </a>
                                                    <input type="hidden" name="goods_category[image]" value="<?=$model['image']['value']?>">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods_category[sort_order]"
                                           value="<?= $model['sort_order'] ?>" required>
                                    <small>数字越小越靠前</small>
                                </div>
                            </div>
                            <div class="am-form-group">
