<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\source_list\index.php";i:1572312537;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1573699389;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title a m-cf">来源列表</div>
                </div>
                        ...
                        <form id="form-search" class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    <?php if (checkPrivilege('store.source_list/add')): ?>
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-success am-radius"
                                               href="<?= url('store.source_list/add') ?>">
...
<!--                                        <a href="../--><?php echo '<?'; ?>
//= $item['img'] ?><!--" title="点击查看大图" target="_blank">-->
                                            <img src="web/uploads/small/<?= $item['img'] ?>" width="72" height="72" alt="">
<!--                                        </a>-->
                                    </td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('store.source_list/edit')): ?>
                                                <a href="<?= url('store.source_list/edit',
                                                    ['id' => $item['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; if (checkPrivilege('store.source_list/delete')): ?>
