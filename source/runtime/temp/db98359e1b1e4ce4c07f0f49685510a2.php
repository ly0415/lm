<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\store_user\index.php";i:1571624106;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1573699389;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <div class="am-form-group">
                            <?php if (checkPrivilege('store.store_user/add')): ?>
                                <div class="am-btn-group am-btn-group-xs">
                                    <a class="am-btn am-btn-default am-btn-success"
                                       href="<?= url('store.store_user/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('store.store_user/edit')): ?>
                                                <a href="<?= url('store.store_user/edit', ['user_id' => $item['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; if (($store['user']['store_user_id'] != $item['id'])
                                                && !$item['is_super']): if (checkPrivilege('store.store_user/delete')): ?>
                                                    <a href="javascript:void(0);"
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('store.store_user/delete') ?>";
