<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\user\edit.php";i:1572676369;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1572400948;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-">性别 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input id="man" type="radio"  name="user[sex]"  <?php if($list['sex']=='男') echo "checked='checked'";?> value="1"/>男<input id="woman"  type="radio" name="user[sex]" value="2"  <?php if($list['sex']=='女') echo "checked='checked'";?>  />女
<!--                                    <input type="text" class="tpl-form-input" name="user[sex]" value="--><?php echo '<?'; ?>
//= $list['sex'] ?><!--"  >-->
