                                    ...
                                    <div class="am-form-file">
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php if ($model['img']): ?>
                                                ...
                                                <div class="file-item">
<!--                                                    <a href="--><?php echo '<?'; ?>
//=$model['img']['big_file_path']?><!--" title="点击查看大图" target="_blank">-->
