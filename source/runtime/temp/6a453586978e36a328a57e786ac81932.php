<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\distri_butor\edit.php";i:1571822047;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1571624106;s:89:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\_template\file_library.php";i:1571624106;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">规则名称 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="disbut[rule_name]"
                                           value="<?= $distublist['rule_name'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">一级分润规则 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="disbut[lev1_prop]"
                                           value="<?= $distublist['lev1_prop'] ?>" required>%
                                    <!--                                    <small>数字越小越靠前</small>-->
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">二级分润规则 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="disbut[lev2_prop]"
                                           value="<?= $distublist['lev2_prop'] ?>" required>%
                                    <!--                                    <small>数字越小越靠前</small>-->
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">三级分润规则 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="disbut[lev3_prop]"
                                           value="<?= $distublist['lev3_prop'] ?>" required>%
                                </div>
                            </div>
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="disbut[store_id][]" multiple data-am-selected="{btnSize: 'sm'}" >
                                        <?php if (isset($storelist)): foreach ($storelist as $role): ?>
                                            <option value="<?= $role['id'] ?>"  <?= (isset($distublist['sto_id']) && (in_array($role['id'],$distublist['sto_id'])))?"selected":"" ?>>
                                                <?= $role['store_name'] ?></option>
                                        <?php endforeach;  else: ?>
                                            <option >没有店铺</option>
                                        <?php endif; ?>
                                    </select>
...
<!--                                <div class="am-u-sm-9 am-u-end">-->
<!--                                    <select name="disbut[store_ids][]" multiple data-am-selected="{btnSize: 'sm'}" >-->
<!--                                        --><?php //if (isset($distublist)): foreach ($distublist as $role): ?>
