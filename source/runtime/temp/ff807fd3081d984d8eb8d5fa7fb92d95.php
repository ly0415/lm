<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\shop\index.php";i:1571822098;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1573699389;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('store.shop/electric_fence')): ?>
                                                <a href="<?= url('store.shop/electric_fence', ['store_id' => $item['id']]) ?>">
                                                    <i class="am-icon-cog"></i> 电子围栏
                                                </a>
                                            <?php endif; if (checkPrivilege('store.shop/setting')): ?>
