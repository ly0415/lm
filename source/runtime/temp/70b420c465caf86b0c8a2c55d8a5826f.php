<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\shop\getpoint.php";i:1571624106;}*/ ?>
<!DOCTYPE html>
<html>
...
<div style="width:912px;position:relative;">
    <div style="height:53px;">
        ...
        <div class="poi">
            ...
            <input type="text" id="poi_cur" value="" readonly/>
            <div class="poi_note">当前地址：</div>
            <input type="text" id="addr_cur" readonly/></div>
    </div>
    <div id="main">
        <div id="tooles">
            <div id="cur_city">
