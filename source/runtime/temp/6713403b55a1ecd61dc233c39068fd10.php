<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\store\business\index.php";i:1571624106;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1572400948;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<!--                            一级业务分类-->
                            <?php if (!empty($list)): foreach ($list as $first): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><?= $first['name'] ?><?php echo '<?'; ?>
if(!empty($first['child'])){foreach ($first['child'] as $v){
                                        echo $v['name'];
                                        }}?></td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('store.business/delete')): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if (checkPrivilege('store.business/edit')): ?>
                                                <a href="<?= url('store.business/edit',
                                                    ['id' => $two['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
