<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\phpStudy\WWW\lmeriPro\web/../source/application/store\view\distri\distri_butor\index.php";i:1571821112;s:73:"D:\phpStudy\WWW\lmeriPro\source\application\store\view\layouts\layout.php";i:1571624106;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <form id="form-search" class="toolbar-form" action="">
                            ...
                            <div class="am-u-sm-12 am-u-md-3">
                                <div class="am-form-group">
                                    <?php if (checkPrivilege('distri_butor/add')): ?>
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-success am-radius"
                                               href="<?= url('distri_butor/add') ?>">
                                                <span class="am-icon-plus"></span> 新增分销规则
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-end">
                                            <select >
                                                <?php if (isset($item['store_name'])): foreach ($item['store_name'] as $role): ?>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('distri_butor/edit')): ?>
                                                <a href="<?= url('distri_butor/edit',
                                                    ['id' => $item['id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; if (checkPrivilege('distri_butor/delete')): ?>
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('distri_butor/delete') ?>";
