...
class AliPayApp extends BaseFrontApp
{
    ...
    public function __construct()
    {
        ...
        $this->config = array(
           ...
           //'alipay_public_key' =>'',
            ...
            'return_url' => "http://www.711home.net/index.php?app=aliPay&act=returnUrl&storeid=".$this->mstored."&lang=".$this->lang,
            'notify_url' => 'http://www.711home.net/index.php?app=aliPay&act=notifyUrl&storeid='.$this->mstored."&lang=".$this->lang,
        );
...
//            }
    ...
    {
        file_put_contents("hjp.txt",'begin'.PHP_EOL,FILE_APPEND);
        file_put_contents("hjp.txt",var_export($_GET,TRUE).PHP_EOL,FILE_APPEND);
        file_put_contents("hjp.txt",var_export($_POST,TRUE).PHP_EOL,FILE_APPEND);
        file_put_contents("hjp.txt",var_export($data,TRUE).PHP_EOL,FILE_APPEND);
        file_put_contents("hjp.txt",'end'.PHP_EOL,FILE_APPEND);
    }
