...
class LikeManagementApp extends BaseStoreApp {
    ...
    public function index()
    {
        ...
        $storeCateList = $storeCateMod->getRelationDatas();
        $this->assign('languageId', $this->languageId);
    ...
    public function add()
    {
        if (IS_POST) {
            ...
            if (method_exists($this->model,  'buildData')) {
                $data = $this->model->buildData($data, $this->storeUserId);
            }
            //插入数据
