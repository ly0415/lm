...
class StatisticsApp extends BaseStoreApp {
    ...
    public function index() {
        ...
        if ($gdInfo) {
            ...
            $topInfo = $orderMod->getGoodsTop10($area_id, $store_id, $gdInfo, 0, $timeSetArr,$this->languageId);
        ...
        $areaArr = $storeCateMod->getAreaArr(1);
        ...
        //订单信息
        $upOrderInfo = $orderMod->getUpOrderCount(10, $area_id, $store_id);
        ...
        //商品TOP10
        $top10 = $orderMod->getGoodsTop10($area_id, $store_id, 'day', 1,$this->languageId);


        $this->assign('top10', $top10);         //商品TOP10
        if ($_GET['lang_id'] == 1) {
            $this->display('statistics/index_1.html');
        } else {
