...
class FissionApp extends BackendApp {
    ...
    public function index()
    {
        ...
        $sql = 'select a.*,b.username,c.store_name from ' . DB_PREFIX . 'fission as a 
                left join ' . DB_PREFIX . 'store as b on a.store_id = b.id 
                left join ' . DB_PREFIX . 'store_lang as c on a.store_id = c.store_id where '.$where;
