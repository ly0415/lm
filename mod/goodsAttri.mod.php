...
class  GoodsAttriMod  extends  BaseMod{
    public function __construct(){
        parent::__construct("goods_attribute");
    }
 ...
 */
    public function getLangData($style_id,$lang_id){
        $catSql="select c.attr_id,c.type_id,c.attr_index,c.attr_input_type,c.attr_values,c.`order`,l.`name` as `attr_name` from ".DB_PREFIX."goods_attribute as c
        left join ".DB_PREFIX."goods_attr_lang as l on c.attr_id=l.a_id
        where c.type_id=".$style_id."  and l.lang_id=".$lang_id;
